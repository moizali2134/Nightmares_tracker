...
abstract class Styles {
  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
     ...
     // primarySwatch: isDarkTheme ? Colors.blue : Colors.blue,
      ...
      hintColor: isDarkTheme ? Color(0xff555353) : Color(0xff96aac7),
      ...
      buttonTheme: Theme.of(context).buttonTheme.copyWith(
          colorScheme: isDarkTheme ? const ColorScheme.dark() : ColorScheme.light()),
      appBarTheme: const AppBarTheme(
        elevation: 0.0,
      ), textSelectionTheme: TextSelectionThemeData(selectionColor: isDarkTheme ? Colors.blue.withOpacity(0.2) : Colors.blueAccent.withOpacity(0.2)),
    );
  }
}